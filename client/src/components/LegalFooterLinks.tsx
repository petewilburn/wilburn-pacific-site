    ...
    disclaimer: {
      ...
      content: (
        <div className="space-y-4 text-muted-foreground">
          ...
          <p>
            <strong>2. Placeholder Content:</strong> Some sections of this site may contain placeholder text or images generated by LLMs as the site is actively being developed. While these placeholders are representative of the type of work performed, they are not intended to represent actual completed projects or final engineering specifications.
          </p>
          <p>
